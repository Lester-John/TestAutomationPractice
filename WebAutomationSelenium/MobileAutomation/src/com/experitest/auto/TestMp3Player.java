...
import objectRepository.ObjectRep;
...
public class TestMp3Player {
	 ...
	 private String reportDirectory = "reports";
		...
		private String testName = "OldTestMp3Player";
...
/*		//TestCase myTestCaseObject = new TestCase(sUDID,sAppPackage,sAppActivity);
		TestCase myTestCaseObject = new TestCase();
		myTestCaseObject.BeforeTest();
	*/
